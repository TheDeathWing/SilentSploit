...
from silentsploit.core.exceptions import OptionValidationError
...
class BasePayload(BaseExploit):
    ...
    def get_encoders(self):
        ...
        for e in all_encoders:
            ...
            module = getattr(importlib.import_module('silentsploit.modules.' + e), "Encoder")
            encoders.append((
    ...
    def get_encoder(self, encoder):
        module_path = "silentsploit/modules/encoders/{}".format(encoder).replace("/", ".")
